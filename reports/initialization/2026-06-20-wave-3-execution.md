...
| SPCX | `asset_analyst.SPCX` | HOLD | SPCX is tracked as an adjacent proxy for SpaceX-style launch, satellite, connectivity, and defense infrastructure scarcity, not as current public SA exposure. | Scheduled scan, SA filing change, company filing/IR update, financing/customer contract, guidance change, or detected valuation dip. |
