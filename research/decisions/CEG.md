...
buy_thesis: Constellation is a high-quality power scarcity proxy, but it is not latest-current SA exposure and should stay watch-only absent promotion or a priced entry.
...
valuation_case: generation fleet value, PPA economics, and relative power scarcity
