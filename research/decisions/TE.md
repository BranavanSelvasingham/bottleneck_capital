...
buy_thesis: T1 Energy is tracked as a current SA holding, but business-model and financing clarity are not strong enough for new capital.
...
valuation_case: capacity value, offtake quality, and funding-adjusted scenario value
...
One-line rationale:
Hold/watch only: T1 Energy is tracked as a current SA holding, but business-model and financing clarity are not strong enough for new capital.
