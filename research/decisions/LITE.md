...
buy_thesis: Lumentum can benefit if AI optical components tighten, but it is not current SA exposure and should remain a watchlist proxy.
...
valuation_case: datacom recovery and optical component scenario value
