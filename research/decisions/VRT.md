...
broken_thesis: ""
next_trigger: Treat as adjacent/historical AI power equipment proxy.
one_line_rationale: SA-adjacent equipment proxy; not latest-current SA holding.
---
# VRT Decision
...
One-line rationale:
SA-adjacent equipment proxy; not latest-current SA holding.
...
Next trigger:
Treat as adjacent/historical AI power equipment proxy.
