...
buy_thesis: Bloom may be a direct answer to grid-constrained AI campuses if customers value rapid onsite power deployment.
...
valuation_case: backlog quality, gross-margin path, and funded growth scenario value
