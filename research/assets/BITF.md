...
thesis_expressed: Bitfarms is a power/site option that could benefit from AI conversion, but current evidence is not strong enough for new capital.
anti_thesis: The equity may remain mostly Bitcoin beta with dilution rather than datacenter scarcity.
hedge_or_sizing: No puts or shorts; use no-action discipline until valuation and thesis evidence justify capital.
invalidation_trigger: No credible AI/HPC path emerges and economics remain dominated by mining exposure.
...
one_line_rationale: "Hold/watch only: Bitfarms is a power/site option that could benefit from AI conversion, but current evidence is not strong enough for new capital."
...
Bitfarms is a power/site option that could benefit from AI conversion, but current evidence is not strong enough for new capital.
...
| Main risk today | Bitcoin price beta, dilution, conversion capex, and weak customer evidence. |
| Main upside driver today | Power portfolio monetization, AI/HPC conversion, or strategic site value. |
...
1. Power portfolio monetization, AI/HPC conversion, or strategic site value.
...
Claim: Bitfarms is a power/site option that could benefit from AI conversion, but current evidence is not strong enough for new capital.
...
Claim: power-site value versus mining NAV and funding dilution. Current baseline does not approve a buy.
...
|---|---:|---|
| Thesis purity | 3 | Miner-to-datacenter optionality. |
...
Valuation frame: power-site value versus mining NAV and funding dilution

| Zone | Meaning | Action |
|---|---|---|
| Approved entry | Not armed in this baseline | No buy |
| Dip investigation | Material drop with no thesis damage | Run `bcap dip-investigate --ticker BITF` |
