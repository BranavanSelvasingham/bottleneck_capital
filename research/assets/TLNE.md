...
asset_role: adjacent_power_proxy
...
one_line_rationale: SA-adjacent power proxy; research only after strict current SA names are triaged.
---
# TLNE - Talen Energy
...
Adjacent or historical SA power proxy, not latest-current public 13F holding.
...
## 12. Open Questions
- Is this still close enough to the SA public portfolio to deserve active tracking?
