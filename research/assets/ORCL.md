...
thesis_expressed: Oracle is tracked as SA reported put exposure; it informs capex duration and AI infrastructure risk, not long-only action.
anti_thesis: OCI growth can be real while equity risk remains valuation/debt/capex sensitive.
...
asset_role: Signal-only enterprise AI infrastructure risk map.
...
| Main risk today | Capex intensity, leverage, customer concentration, and crowded AI infrastructure expectations. |
| Main upside driver today | Read-through to AI cloud demand, capex burden, debt, and contracted backlog quality. |
...
Why this asset belongs here: Signal-only enterprise AI infrastructure risk map.

What this asset is actually a bet on:

1. Read-through to AI cloud demand, capex burden, debt, and contracted backlog quality.
...
Claim: Oracle is tracked as SA reported put exposure; it informs capex duration and AI infrastructure risk, not long-only action.

Evidence for:
- Situational Awareness LP public 13F-HR, 2026-03-31 period, filed 2026-05-18; configs/watchlist.yaml; configs/sa_universe.yaml; research/agent_packets/wave_1/ORCL.md; wave execution memo.
- Sleeve thesis: `enterprise_ai_infra`.

Evidence against:
- OCI growth can be real while equity risk remains valuation/debt/capex sensitive.
- Capex intensity, leverage, customer concentration, and crowded AI infrastructure expectations.
...
|---|---:|---|
| Thesis purity | 3 | Signal-only enterprise AI infrastructure risk map. |
| Durability | 3 | Requires scheduled evidence refresh. |
| Balance sheet resilience | 3 | Main risk: Capex intensity, leverage, customer concentration, and crowded AI infrastructure expectations. |
| Management / execution | 3 | Execution still matters. |
| Strategic scarcity | 2 | Upside: Read-through to AI cloud demand, capex burden, debt, and contracted backlog quality. |
...
| Dip investigation | Material drop with no thesis damage | Run `bcap dip-investigate --ticker ORCL` |
...
- `research/agent_packets/wave_1/ORCL.md`
