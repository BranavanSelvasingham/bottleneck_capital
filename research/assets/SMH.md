...
Why this asset belongs here: Signal-only semiconductor beta and crowding map.

What this asset is actually a bet on:

1. Read-through to semiconductor crowding, index concentration, and AI beta risk.
...
Claim: SMH is useful for interpreting SA semiconductor hedge/crowding risk, not for a long-only ETF trade right now.

Evidence for:
- Situational Awareness LP public 13F-HR, 2026-03-31 period, filed 2026-05-18; configs/watchlist.yaml; configs/sa_universe.yaml; research/agent_packets/wave_1/SMH.md; wave execution memo.
...
|---|---:|---|
| Thesis purity | 3 | Signal-only semiconductor beta and crowding map. |
| Durability | 3 | Requires scheduled evidence refresh. |
| Balance sheet resilience | 3 | Main risk: Crowded semicap/semi valuation, broad ETF exposure, and hedge-signal ambiguity. |
| Management / execution | 3 | Execution still matters. |
| Strategic scarcity | 2 | Upside: Read-through to semiconductor crowding, index concentration, and AI beta risk. |
...
| Downside survivability | 2 | Invalidation: Separate long-only ETF thesis documented with valuation, sizing, and invalidation. |
...
| Dip investigation | Material drop with no thesis damage | Run `bcap dip-investigate --ticker SMH` |
