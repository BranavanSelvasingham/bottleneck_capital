...
asset_role: Low-priority adjacent water/thermal infrastructure proxy.
...
| Main risk today | Thesis remoteness, valuation, cyclicality, and non-SA status. |
| Main upside driver today | Datacenter water, thermal, and infrastructure demand becoming material. |
...
Why this asset belongs here: Low-priority adjacent water/thermal infrastructure proxy.

What this asset is actually a bet on:

1. Datacenter water, thermal, and infrastructure demand becoming material.
...
Claim: Watts is a possible datacenter water/thermal infrastructure read-through, but the AI link is not yet material enough for action.

Evidence for:
- Situational Awareness LP public 13F-HR, 2026-03-31 period, filed 2026-05-18; configs/watchlist.yaml; configs/sa_universe.yaml; research/agent_packets/wave_3/WTS.md; wave execution memo.
...
Claim: end-market mix and datacenter contribution scenario value. Current baseline does not approve a buy.
...
|---|---:|---|
| Thesis purity | 2 | Low-priority adjacent water/thermal infrastructure proxy. |
| Durability | 2 | Requires scheduled evidence refresh. |
| Balance sheet resilience | 2 | Main risk: Thesis remoteness, valuation, cyclicality, and non-SA status. |
| Management / execution | 2 | Execution still matters. |
| Strategic scarcity | 2 | Upside: Datacenter water, thermal, and infrastructure demand becoming material. |
| Contract quality | 2 | Needs source-event verification. |
| Customer quality | 2 | Needs source-event verification. |
| Pricing power | 2 | Valuation frame: end-market mix and datacenter contribution scenario value. |
| Downside survivability | 2 | Invalidation: No evidence that datacenter infrastructure materially changes earnings power. |
...
Valuation frame: end-market mix and datacenter contribution scenario value

| Zone | Meaning | Action |
|---|---|---|
| Approved entry | Not armed in this baseline | No buy |
| Dip investigation | Material drop with no thesis damage | Run `bcap dip-investigate --ticker WTS` |
...
- `research/agent_packets/wave_3/WTS.md`
