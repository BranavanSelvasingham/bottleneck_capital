...
one_line_rationale: "RESEARCH_REQUIRED / NO ADD: the HIVE memo bounds the prior move, but current valuation, catalyst, financing, or live-source evidence remains insufficient for capital."
asset_role: Miner with GPU/HPC pivot optionality.
...
| Main risk today | Mining cyclicality, jurisdiction, financing, and limited contract proof. |
| Main upside driver today | GPU/HPC revenue, power/site monetization, and AI hosting progress. |
...
Why this asset belongs here: Miner with GPU/HPC pivot optionality.

What this asset is actually a bet on:

1. GPU/HPC revenue, power/site monetization, and AI hosting progress.
...
Claim: HIVE has a plausible HPC pivot, but the equity remains too tied to mining until GPU/HPC revenue and contracts are clearer.

Evidence for:
- Situational Awareness LP public 13F-HR, 2026-03-31 period, filed 2026-05-18; configs/watchlist.yaml; configs/sa_universe.yaml; research/agent_packets/wave_2/HIVE.md; wave execution memo.
...
Claim: mining NAV plus verified HPC revenue option value. Current baseline does not approve a buy.
...
|---|---:|---|
| Thesis purity | 3 | Miner with GPU/HPC pivot optionality. |
| Durability | 3 | Requires scheduled evidence refresh. |
| Balance sheet resilience | 2 | Main risk: Mining cyclicality, jurisdiction, financing, and limited contract proof. |
| Management / execution | 2 | Execution still matters. |
| Strategic scarcity | 2 | Upside: GPU/HPC revenue, power/site monetization, and AI hosting progress. |
| Contract quality | 2 | Needs source-event verification. |
| Customer quality | 2 | Needs source-event verification. |
| Pricing power | 2 | Valuation frame: mining NAV plus verified HPC revenue option value. |
| Downside survivability | 2 | Invalidation: HPC revenue remains immaterial and mining economics dominate value. |
...
Valuation frame: mining NAV plus verified HPC revenue option value

| Zone | Meaning | Action |
|---|---|---|
| Approved entry | Not armed in this baseline | No buy |
| Dip investigation | Material drop with no thesis damage | Run `bcap dip-investigate --ticker HIVE` |
...
- `research/agent_packets/wave_2/HIVE.md`
