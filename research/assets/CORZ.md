...
Core Scientific is one of the cleaner miner-to-HPC conversion candidates because contracted hosting can separate value from Bitcoin beta.
...
| Main risk today | Counterparty concentration, financing, mining residual exposure, and execution. |
| Main upside driver today | HPC contract durability, CoreWeave-related demand, and site/power monetization. |
...
Why this asset belongs here: HPC hosting conversion candidate.

What this asset is actually a bet on:

1. HPC contract durability, CoreWeave-related demand, and site/power monetization.
...
- Customer concentration, post-restructuring capital needs, or power delivery risk can still make the equity fragile.
...
Claim: Core Scientific is one of the cleaner miner-to-HPC conversion candidates because contracted hosting can separate value from Bitcoin beta.

Evidence for:
- Situational Awareness LP public 13F-HR, 2026-03-31 period, filed 2026-05-18; configs/watchlist.yaml; configs/sa_universe.yaml; research/agent_packets/wave_2/CORZ.md; wave execution memo.
...
Claim: contracted HPC backlog plus power capacity value. Current baseline does not approve a buy.
...
|---|---:|---|
| Thesis purity | 3 | HPC hosting conversion candidate. |
| Durability | 3 | Requires scheduled evidence refresh. |
| Balance sheet resilience | 3 | Main risk: Counterparty concentration, financing, mining residual exposure, and execution. |
| Management / execution | 3 | Execution still matters. |
| Strategic scarcity | 3 | Upside: HPC contract durability, CoreWeave-related demand, and site/power monetization. |
| Contract quality | 3 | Needs source-event verification. |
| Customer quality | 3 | Needs source-event verification. |
| Pricing power | 3 | Valuation frame: contracted HPC backlog plus power capacity value. |
| Downside survivability | 3 | Invalidation: HPC contracts weaken or financing prevents profitable conversion of sites. |
...
Valuation frame: contracted HPC backlog plus power capacity value

| Zone | Meaning | Action |
|---|---|---|
| Approved entry | Not armed in this baseline | No buy |
| Dip investigation | Material drop with no thesis damage | Run `bcap dip-investigate --ticker CORZ` |
...
- `research/agent_packets/wave_2/CORZ.md`
