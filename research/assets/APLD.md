...
one_line_rationale: "RESEARCH_REQUIRED / NO ADD: the APLD memo bounds the prior move, but current valuation, catalyst, financing, or live-source evidence remains insufficient for capital."
asset_role: AI datacenter conversion and power-site optionality.
...
RESEARCH_REQUIRED: the July 15 10:45 sentinel flagged an unresolved APLD price dislocation; cause, valuation, AI/HPC contract quality, financing, delivery risk, and power/site economics must be refreshed before capital.
...
| Main risk today | Customer concentration, project finance, dilution, power delivery, and execution. |
| Main upside driver today | Signed customer demand, power access, and funded datacenter buildout. |
...
Why this asset belongs here: AI datacenter conversion and power-site optionality.

What this asset is actually a bet on:

1. Signed customer demand, power access, and funded datacenter buildout.
...
Claim: Applied Digital may monetize power and sites into AI/HPC datacenter capacity, but the underwriting hinges on contract quality and financing.

Evidence for:
- Situational Awareness LP public 13F-HR, 2026-03-31 period, filed 2026-05-18; configs/watchlist.yaml; configs/sa_universe.yaml; research/agent_packets/wave_2/APLD.md; wave execution memo.
...
What would break it:
- Major customer/financing failure or evidence that sites cannot support contracted AI load.

Decision impact:
RESEARCH_REQUIRED. Do not add capital until the July 15 10:45 sentinel dislocation is resolved
with primary-source review of AI/HPC contract quality, financing, delivery risk, power/site
...
Claim: contracted backlog value plus power-site replacement cost. Current baseline does not approve a buy.
...
|---|---:|---|
| Thesis purity | 3 | AI datacenter conversion and power-site optionality. |
| Durability | 3 | Requires scheduled evidence refresh. |
| Balance sheet resilience | 3 | Main risk: Customer concentration, project finance, dilution, power delivery, and execution. |
| Management / execution | 3 | Execution still matters. |
| Strategic scarcity | 3 | Upside: Signed customer demand, power access, and funded datacenter buildout. |
| Contract quality | 3 | Needs source-event verification. |
| Customer quality | 3 | Needs source-event verification. |
| Pricing power | 2 | Valuation frame: contracted backlog value plus power-site replacement cost. |
| Downside survivability | 2 | Invalidation: Major customer/financing failure or evidence that sites cannot support contracted AI load. |
...
Valuation frame: contracted backlog value plus power-site replacement cost

| Zone | Meaning | Action |
|---|---|---|
| Approved entry | Not armed in this baseline | No buy |
| Dip investigation | Material drop with no thesis damage | Run `bcap dip-investigate --ticker APLD` |
...
- July 15, 2026 10:45 sentinel: event `5b8cc852db70cff2c60645e9` flagged APLD price dislocation: intraday -5.9%. Treat as RESEARCH_REQUIRED until cause and valuation are resolved.
- Wave: 2
...
- `research/agent_packets/wave_2/APLD.md`
...
- Resolve the July 15 10:45 APLD dislocation with primary company/filing/IR evidence, AI/HPC contract quality, financing, delivery risk, power/site economics, and valuation.
