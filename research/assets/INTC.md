...
Why this asset belongs here: Foundry and domestic semiconductor capacity turnaround.

What this asset is actually a bet on:

1. Foundry progress, process roadmap execution, subsidies, and strategic customer wins.
...
Claim: Intel is a possible strategic foundry bottleneck, but execution, capital intensity, and put exposure keep the stock on hold.

Evidence for:
- Situational Awareness LP public 13F-HR, 2026-03-31 period, filed 2026-05-18; configs/watchlist.yaml; configs/sa_universe.yaml; research/agent_packets/wave_2/INTC.md; wave execution memo.
...
Claim: sum-of-the-parts foundry/product scenario value. Current baseline does not approve a buy.
...
|---|---:|---|
| Thesis purity | 3 | Foundry and domestic semiconductor capacity turnaround. |
| Durability | 3 | Requires scheduled evidence refresh. |
| Balance sheet resilience | 3 | Main risk: Execution delays, balance sheet strain, foundry losses, and competitive pressure. |
| Management / execution | 3 | Execution still matters. |
| Strategic scarcity | 3 | Upside: Foundry progress, process roadmap execution, subsidies, and strategic customer wins. |
| Contract quality | 3 | Needs source-event verification. |
| Customer quality | 2 | Needs source-event verification. |
| Pricing power | 2 | Valuation frame: sum-of-the-parts foundry/product scenario value. |
| Downside survivability | 2 | Invalidation: Foundry roadmap slips further or capital needs overwhelm strategic value. |
| Hedgeability | 2 | Long-only hedge is sizing/no action. |

Long-term owner score: 26 / 50

## 5. Valuation and Entry Discipline

Valuation frame: sum-of-the-parts foundry/product scenario value

| Zone | Meaning | Action |
|---|---|---|
| Approved entry | Not armed in this baseline | No buy |
| Dip investigation | Material drop with no thesis damage | Run `bcap dip-investigate --ticker INTC` |
...
- `research/agent_packets/wave_2/INTC.md`
