...
thesis_expressed: TSMC is a core foundry/advanced packaging scarcity asset, but geopolitics, customer concentration, and SA put exposure require sizing discipline.
anti_thesis: Geopolitical risk or capex cyclicality can dominate even a strong structural moat.
hedge_or_sizing: No puts or shorts; require smaller sizing, higher valuation hurdle, and explicit invalidation.
invalidation_trigger: Leading-edge foundry/packaging share or geopolitical risk invalidates ownership quality.
...
one_line_rationale: "Hold/watch only: TSMC is a core foundry/advanced packaging scarcity asset, but geopolitics, customer concentration, and SA put exposure require sizing discipline."
...
confidence_score: 55
valuation_attractiveness_score: 36
urgency_score: 90
...
TSMC is a core foundry/advanced packaging scarcity asset, but geopolitics, customer concentration, and SA put exposure require sizing discipline.
...
| Main risk today | Taiwan geopolitical risk, customer concentration, capex cycle, and put-signal risk. |
...
Claim: TSMC is a core foundry/advanced packaging scarcity asset, but geopolitics, customer concentration, and SA put exposure require sizing discipline.

Evidence for:
- Situational Awareness LP public 13F-HR, 2026-03-31 period, filed 2026-05-18; configs/watchlist.yaml; configs/sa_universe.yaml; research/agent_packets/wave_1/TSM.md; wave execution memo.
...
Claim: foundry earnings power plus advanced-packaging scarcity scenario value. Current baseline does not approve a buy.
...
| Balance sheet resilience | 5 | Main risk: Taiwan geopolitical risk, customer concentration, capex cycle, and put-signal risk. |
| Management / execution | 5 | Execution still matters. |
| Strategic scarcity | 4 | Upside: Advanced-node foundry demand, CoWoS/packaging scarcity, and AI accelerator volume. |
| Contract quality | 4 | Needs source-event verification. |
| Customer quality | 4 | Needs source-event verification. |
| Pricing power | 4 | Valuation frame: foundry earnings power plus advanced-packaging scarcity scenario value. |
| Downside survivability | 4 | Invalidation: Leading-edge foundry/packaging share or geopolitical risk invalidates ownership quality. |
| Hedgeability | 4 | Long-only hedge is sizing/no action. |

Long-term owner score: 44 / 50
...
| Dip investigation | Material drop with no thesis damage | Run `bcap dip-investigate --ticker TSM` |
